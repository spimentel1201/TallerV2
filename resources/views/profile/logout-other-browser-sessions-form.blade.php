<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Maneja y activa las sesiones en otros navegadores.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                {{ __('Cerrar otro inicio de sesión') }}
            </x-slot>

            <x-slot name="content">
                {{ __('Por favor ingresa tu contraseña para confirmar que deseas cerrar la sesiones abiertas en otro navegador u otros dispositivos.') }}
