...
@section('content')
    ...
    <nav class="navbar navbar-light float-right">
        <form class="form-inline">
            <input name="buscarpor" class="form-control mr-sm-2" type="search" placeholder="Busqueda" aria-label="Search">
            <select name="cosa" id="cosa" class="form-control mr-sm-2">
                <option selected>Seleccione</option>
                <option value="codigo">Codigo</option>
                <option value="nombresC">Nombre</option>
                <option value="apellidosC">Apellidos</option>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="guias" class="table table-striped table-bordered table-order-column shadow-lg mt-4" style="width:100%">
